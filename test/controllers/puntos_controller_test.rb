...
class PuntosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create punto" do
    assert_difference('Punto.count') do
      post puntos_url, params: { punto: { angulo: @punto.angulo, distancia: @punto.distancia, lat: @punto.lat, long: @punto.long, nombre: @punto.nombre, proyecto_id: @punto.proyecto_id, secuencia: @punto.secuencia } }
    end
  ...
  test "should update punto" do
    patch punto_url(@punto), params: { punto: { angulo: @punto.angulo, distancia: @punto.distancia, lat: @punto.lat, long: @punto.long, nombre: @punto.nombre, proyecto_id: @punto.proyecto_id, secuencia: @punto.secuencia } }
